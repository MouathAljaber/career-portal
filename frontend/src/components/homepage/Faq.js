  ...
  },
{
  ...
  },
  {
    ...
    answer:
      "Both paid and unpaid internships exist. Stipend details are shown clearly."
  },
  {
    id: 6,
    question: "Will I need a blocked account?",
    answer:
      "Depends on duration and stipend. We guide you after selection"
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Clear answers to common questions students have before applying for internships and jobs in Germany.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-10 pt-8 border-t border-gray-200">
          {faqs.map((faq) => (
            <div key={faq.id} className="w-full md:w-[48%] lg:w-[30%] bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition
