    ...
    <section className="py-16 lg:py-20 bg-gray-50" id="how-it-works">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">How EVLEENE Works</h2>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-4xl font-bold text-gray-100 leading-none">{step.step}</span>
              </div>

              <div className="flex flex-col flex-1">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">{step.title}</h3>
                <p className="text-sm text-gray-800 mb-4 leading-relaxed font-medium">{step.description}</p>

                <ul className="space-y-2 mt-2">
                  {step.features.map(feature => (
                    <li key={feature} className="flex items-center gap-2 text-xs text-gray-800 font-medium">
                      <CheckCircle2
