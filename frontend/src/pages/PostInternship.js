...
const PostInternship = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      await internshipAPI.create(postData);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Post New Internship</h1>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Describe the internship opportunity, what the intern will learn, and what makes your company a great place to work..."
                  rows={6}
