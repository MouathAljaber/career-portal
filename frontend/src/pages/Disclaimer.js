      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              The platform content is created with the greatest care. We assume no liability for
          ...
          <section>
            ...
            <p>
              Our platform contains links to third-party websites. We are not responsible for the
          ...
          <section>
            ...
            <p>
              We strive for uninterrupted operation but cannot guarantee continuous availability.
            </p>
          </section>
        </div>
      </div>
